		...
		<table cellpadding="0" width="100%" class="sTable mTable myTable" id="checkAll" >
					...
					<table cellpadding="0" cellspacing="0" width="80%"><tbody>
						...
						<tr>
							<td class="label" style="width:40px;">
								<label for="filter_id">Mã số</label></td>
							<td class="item">
							...
							<td class="item" style="width:155px;"><input name="title" value="" id="filter_title" type="text" style="width:155px;"></td>
							
							
							
							<td style="width:150px">
							<input type="submit" class="button blueB" value="Lọc">
							<input type="reset" class="basic" value="Reset" onclick="window.location.href = '<?= admin_url('/news') ?>'; ">
							</td>
				...
				<tr>
					<td colspan="6">
						 <div class="list_action itemActions">
								<a href="#submit" id="submit" class="button blueB" url="<?= admin_url("/news/delete_all") ?>">
			...
			<tbody class="list_item">
					...
					<div class="image_thumb">
						<img src="<?= base_url()?>upload/news/<?php echo $row->image_link ?>" height="50">
						<div class="clear"></div>
					</div>
					...
					<td class="option textC">
							...
							<img src="<?=public_url('admin')?>/images/icons/color/star.png">
												...
												<a href="news/view/9.html" target="_blank" class="tipS" title="Xem chi tiết sản phẩm">
