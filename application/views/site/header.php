...
<div class='top'><!-- The top -->
      ...
      <div id="cart_expand" class="cart"> 
            <a style="color: red" href="gio-hang.html" class="cart_link">
               Giỏ hàng của tôi 
            </a> 
    ...
    <div class='clear'></div><!-- clear float --> 
           ...
           <ul class="menu_top">
                <li class="active index-li"><a href="<?= base_url() ?>">Trang chủ </a></li>
                ...
                <li class=""><a href="<?= site_url('user/') ?>">Xin chào <span style="color:red"><?= $user_info->name ?> </span></a></li>
                <li class=""><a href="<?= site_url('user/logout') ?>">Đăng xuất</a></li>
                <?php else: ?>
                <li class=""><a href="<?= site_url('user/register') ?>">Đăng ký</a></li>
                <li class=""><a href="<?= site_url('user/login') ?>">Đăng nhập</a></li>
                <?php endif; ?>
                           </ul>
