...
<div class="box-center"><!-- The box-center product-->
             <div class="tittle-box-center">
		        <h2>Sản phẩm bạn đang tham gia đấu giá</h2>
		      </div>
...
<div class="box-center"><!-- The box-center product-->
             <div class="tittle-box-center">
		        <h2>Sản phẩm mà bạn đã chiến thắng</h2>
		      </div>
		      <div class="box-content-center product"><!-- The box-content-center -->
                  ...
                  <div class='product_item'>
                       ...
                       <p class='price'>
                        ...
                        <?= number_format(intval($product->maxMoney)) ?>  
                       ...
                       <div class='action'>
                           <p style='float:left;margin-left:10px'>Lượt xem: <b> <?= $product->view ?> </b></p>
                         <a class='button' href="<?= base_url('product/view/'.$product->id) ?>" title='Mua ngay'>Xem ngay</a>
                         <div class='clear'></div>
                       </div>
                  </div>
                  <?php endforeach; ?>            
